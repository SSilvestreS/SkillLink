...
// // import { UseGuards } from '@nestjs/common'; // Removido - não utilizado // Removido - não utilizado
import { JwtService } from '@nestjs/jwt';

import { NotificationsService } from './notifications.service';
// // import { JwtAuthGuard } from '../auth/guards/jwt-auth.guard'; // Removido - não utilizado // Removido - não utilizado
